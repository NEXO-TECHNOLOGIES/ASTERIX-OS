# [ASTERIX] ASTERIX OS v1.0 — Capa Cibernética y Entorno de Inteligencia
...
> **[NET] Idioma**: [English](../../README.md) | [Español](README.es.md) | [Français](README.fr.md) | [Deutsch](README.de.md) | [中文](README.zh.md) | [العربية](README.ar.md) | [Русский](README.ru.md)
...
3. **[TOOL] Reparador de Código Nativo en Rust y C (`ax code-repair`)**:
...
4. **[NET] Puente de Computación y Arranque Dual (`ax os-computing`)**:
