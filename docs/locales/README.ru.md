# [ASTERIX] ASTERIX OS v1.0 — Кибернетическая Среда & Система Системной Разведки
...
> **[NET] Язык**: [English](../../README.md) | [Español](README.es.md) | [Français](README.fr.md) | [Deutsch](README.de.md) | [中文](README.zh.md) | [العربية](README.ar.md) | [Русский](README.ru.md)
...
3. **[TOOL] Нативный Движок Восстановления Кода на Rust и C (`ax code-repair`)**:
...
4. **[NET] Мост Dual-Boot и Вычислительной Синергии (`ax os-computing`)**:
