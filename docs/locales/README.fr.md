# [ASTERIX] ASTERIX OS v1.0 — Couche Cybernétique & Environnement d'Intelligence
...
> **[NET] Langue**: [English](../../README.md) | [Español](README.es.md) | [Français](README.fr.md) | [Deutsch](README.de.md) | [中文](README.zh.md) | [العربية](README.ar.md) | [Русский](README.ru.md)
...
3. **[TOOL] Moteur Natif de Réparation de Code Rust & C (`ax code-repair`)**:
...
4. **[NET] Pont de Calcul Multi-OS & Dual-Boot (`ax os-computing`)**:
