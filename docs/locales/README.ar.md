# [ASTERIX] ASTERIX OS v1.0 — بيئة الاستخبارات السيبرانية وتشغيل الأنظمة المتقدمة
...
> **[NET] اللغة**: [English](../../README.md) | [Español](README.es.md) | [Français](README.fr.md) | [Deutsch](README.de.md) | [中文](README.zh.md) | [العربية](README.ar.md) | [Русский](README.ru.md)
...
## [RUN] أبرز الميزات والأنظمة الفرعية
...
3. **[TOOL] محرك إصلاح الشيفرات المكتوب بلغة Rust و C (`ax code-repair`)**:
...
4. **[NET] جسر الحوسبة المشتركة والإقلاع المزدوج (`ax os-computing`)**:
