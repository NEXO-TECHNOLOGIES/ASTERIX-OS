# [ASTERIX] ASTERIX OS v1.0 — Cybernetische Ebene & System-Intelligenzumgebung
...
> **[NET] Sprache**: [English](../../README.md) | [Español](README.es.md) | [Français](README.fr.md) | [Deutsch](README.de.md) | [中文](README.zh.md) | [العربية](README.ar.md) | [Русский](README.ru.md)
...
3. **[TOOL] Nativer Code-Reparatur-Engine in Rust & C (`ax code-repair`)**:
...
4. **[NET] Dual-Boot- & Host-Kollaborationsbrücke (`ax os-computing`)**:
