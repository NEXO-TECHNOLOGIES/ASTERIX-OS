#  ASTERIX OS Master Cybersecurity Arsenal & Tool Registry
...
## [TARGET] Architecture: Zero-Bloat On-Demand Arsenal
...
## [HOST] CLI Tool Management (`ax arsenal` / `ax tools`)
...
## [STATS] Complete Tool Matrix by Category

### 1. [SCAN] Reconnaissance, OSINT & Asset Discovery
| Tool | GitHub Repository | Status | Installation Method |
| :--- | :--- | :---: | :--- |
| **`nmap`** | [nmap/nmap](https://github.com/nmap/nmap) | `[OK] Pre-Installed` | `sudo apt install -y nmap` |
| **`masscan`** | [robertdavidgraham/masscan](https://github.com/robertdavidgraham/masscan) | `[OK] Pre-Installed` | `sudo apt install -y masscan` |
...
### 2. [SEC] Vulnerability Auditing & Scanning
| Tool | GitHub Repository | Status | Installation Method |
| :--- | :--- | :---: | :--- |
| **`nikto`** | [sullo/nikto](https://github.com/sullo/nikto) | `[OK] Pre-Installed` | `sudo apt install -y nikto` |
| **`commix`** | [commixproject/commix](https://github.com/commixproject/commix) | `[OK] Pre-Installed` | `sudo apt install -y commix` |
...
### 3. [NET] Web Application Security & Fuzzing
| Tool | GitHub Repository | Status | Installation Method |
| :--- | :--- | :---: | :--- |
| **`sqlmap`** | [sqlmapproject/sqlmap](https://github.com/sqlmapproject/sqlmap) | `[OK] Pre-Installed` | `sudo apt install -y sqlmap` |
| **`gobuster`** | [OJ/gobuster](https://github.com/OJ/gobuster) | `[OK] Pre-Installed` | `sudo apt install -y gobuster` |
| **`ffuf`** | [ffuf/ffuf](https://github.com/ffuf/ffuf) | `[OK] Pre-Installed` | `sudo apt install -y ffuf` |
| **`whatweb`** | [urbanadventurer/WhatWeb](https://github.com/urbanadventurer/WhatWeb) | `[OK] Pre-Installed` | `sudo apt install -y whatweb` |
...
### 4. [KEY] Password Auditing & Wordlists
| Tool | GitHub Repository | Status | Installation Method |
| :--- | :--- | :---: | :--- |
| **`hashcat`** | [hashcat/hashcat](https://github.com/hashcat/hashcat) | `[OK] Pre-Installed` | `sudo apt install -y hashcat` |
| **`john`** | [openwall/john](https://github.com/openwall/john) | `[OK] Pre-Installed` | `sudo apt install -y john` |
| **`hydra`** | [vanhauser-thc/thc-hydra](https://github.com/vanhauser-thc/thc-hydra) | `[OK] Pre-Installed` | `sudo apt install -y hydra` |
| **`medusa`** | [jmk-foofus/medusa](https://github.com/jmk-foofus/medusa) | `[OK] Pre-Installed` | `sudo apt install -y medusa` |
| **`crunch`** | [jim3ma/crunch](https://github.com/jim3ma/crunch) | `[OK] Pre-Installed` | `sudo apt install -y crunch` |
| **`cewl`** | [digininja/CeWL](https://github.com/digininja/CeWL) | `[OK] Pre-Installed` | `sudo apt install -y cewl` |
| **`ncrack`** | [nmap/ncrack](https://github.com/nmap/ncrack) | `[OK] Pre-Installed` | `sudo apt install -y ncrack` |
| **`seclists`** | [danielmiessler/SecLists](https://github.com/danielmiessler/SecLists) | `[*] On-Demand` | `sudo apt install -y seclists` |

---

### 5. [SIGNAL] Wireless & Radio Warfare
| Tool | GitHub Repository | Status | Installation Method |
| :--- | :--- | :---: | :--- |
| **`aircrack-ng`** | [aircrack-ng/aircrack-ng](https://github.com/aircrack-ng/aircrack-ng) | `[OK] Pre-Installed` | `sudo apt install -y aircrack-ng` |
| **`wifite2`** | [derv82/wifite2](https://github.com/derv82/wifite2) | `[OK] Pre-Installed` | `sudo apt install -y wifite` |
| **`reaver`** | [t6x/reaver-wps-fork-t6x](https://github.com/t6x/reaver-wps-fork-t6x) | `[OK] Pre-Installed` | `sudo apt install -y reaver` |
| **`bully`** | [aanarchyy/bully](https://github.com/aanarchyy/bully) | `[OK] Pre-Installed` | `sudo apt install -y bully` |
| **`pixiewps`** | [wiire-a/pixiewps](https://github.com/wiire-a/pixiewps) | `[OK] Pre-Installed` | `sudo apt install -y pixiewps` |
| **`kismet`** | [kismetwireless/kismet](https://github.com/kismetwireless/kismet) | `[OK] Pre-Installed` | `sudo apt install -y kismet` |
...
| Tool | GitHub Repository | Status | Installation Method |
| :--- | :--- | :---: | :--- |
| **`metasploit`** | [rapid7/metasploit-framework](https://github.com/rapid7/metasploit-framework) | `[OK] Pre-Installed` | Automated build hook |
...
| Tool | GitHub Repository | Status | Installation Method |
| :--- | :--- | :---: | :--- |
| **`proxychains-ng`**| [rofl0r/proxychains-ng](https://github.com/rofl0r/proxychains-ng) | `[OK] Pre-Installed` | `sudo apt install -y proxychains4` |
| **`socat`** | [3ndG4me/socat](https://github.com/3ndG4me/socat) | `[OK] Pre-Installed` | `sudo apt install -y socat` |
...
| Tool | GitHub Repository | Status | Installation Method |
| :--- | :--- | :---: | :--- |
| **`binwalk`** | [ReFirmLabs/binwalk](https://github.com/ReFirmLabs/binwalk) | `[OK] Pre-Installed` | `sudo apt install -y binwalk` |
| **`radare2`** | [radareorg/radare2](https://github.com/radareorg/radare2) | `[OK] Pre-Installed` | `sudo apt install -y radare2` |
| **`foremost`** | [korczis/foremost](https://github.com/korczis/foremost) | `[OK] Pre-Installed` | `sudo apt install -y foremost` |
| **`sleuthkit`** | [sleuthkit/sleuthkit](https://github.com/sleuthkit/sleuthkit) | `[OK] Pre-Installed` | `sudo apt install -y sleuthkit` |
| **`exiftool`** | [exiftool/exiftool](https://github.com/exiftool/exiftool) | `[OK] Pre-Installed` | `sudo apt install -y exiftool` |
