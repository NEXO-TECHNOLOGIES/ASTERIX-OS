...
alias ax-web-structure='ax web-structure'
alias ax-curl-tree='ax curl-tree'
alias ax-webdump='ax webdump'
alias ax-mobile-sys='ax mobile-sys'
alias curl-tree='ax curl-tree'
alias webdump='ax webdump'
alias web-structure='ax web-structure'
alias mobile-sys='ax mobile-sys'
...
alias ax-power='ax power'
alias power='ax power'
alias ax-cleanpro='ax clean-pro'
alias cleanpro='ax clean-pro'
alias ax-flow='ax flow'
alias flow='ax flow'
alias ax-sslaudit='ax ssl-audit'
alias sslaudit='ax ssl-audit'
alias ax-hashdeep='ax hashdeep'
alias hashdeep='ax hashdeep'
alias ax-yarascan='ax yara-scan'
alias yarascan='ax yara-scan'
alias ax-macguard='ax mac-guard'
...
alias ax-ai='ax ai'
alias ask-ai='ax ai ask'
alias ax-chat='ax ai chat'
alias ax-expert='ax ai'
alias ax-compile='ax auto-compile'
alias ax-autocompile='ax auto-compile'
alias ax-fix='ax auto-compile'
